...
exports.addHarpWebpackConfig = void 0;
const CopyWebpackPlugin = require("copy-webpack-plugin");
const HtmlWebpackPlugin = require("html-webpack-plugin");
const WebpackMerge = require("webpack-merge");
function addHarpWebpackConfig(config, harpConfig) {
    ...
    const mainConfig = (mainEntry === null || mainEntry === void 0 ? void 0 : mainEntry.match(/\.tsx?$/)) ? WebpackMerge.smart(baseConfig, typescriptConfig)
        : baseConfig;
    const bundles = [
        WebpackMerge.smart(Object.assign(Object.assign({}, mainConfig), { plugins: createPlugins(harpConfig === undefined ? undefined : harpConfig.htmlTemplate), stats: {
                all: false,
                timings: true,
                exclude: "resources/",
                errors: true,
    ...
    if (harpConfig !== undefined && harpConfig.decoderEntry !== undefined) {
        const decoderConfig = harpConfig.decoderEntry.endsWith(".ts")
            ...
            : baseConfig;
        bundles.push(WebpackMerge.smart(Object.assign({ target: "webworker", entry: {
                decoder: harpConfig.decoderEntry
            } }, decoderConfig), userConfig));
    }
    return bundles;
}
exports.addHarpWebpackConfig = addHarpWebpackConfig;
function createPlugins(htmlTemplate) {
    const plugins = [
...
//# sourceMappingURL=HarpWebpackConfig.js.map