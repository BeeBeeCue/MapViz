 ...
 * @internal
 */
export declare const VECTOR_TILE_DECODER_SERVICE_TYPE = "vector-tile-decoder";
/**
 ...
 * @internal
 */
export declare const GEOJSON_TILER_SERVICE_TYPE = "geojson-tiler";
//# sourceMappingURL=OmvDecoderDefs.d.ts.map