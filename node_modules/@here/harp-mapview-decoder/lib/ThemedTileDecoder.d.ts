import { DecodedTile, DecoderOptions, ITileDecoder, OptionsMap, TileInfo } from "@here/harp-datasource-protocol";
 ...
 * reasons.
 */
export declare abstract class ThemedTileDecoder implements ITileDecoder {
    languages?: string[];
    m_storageLevelOffset: number;
    protected m_styleSetEvaluator?: StyleSetEvaluator;
    abstract connect(): Promise<void>;
    dispose(): void;
    decodeTile(data: ArrayBufferLike, tileKey: TileKey, projection: Projection): Promise<DecodedTile>;
     ...
     */
    abstract decodeThemedTile(data: ArrayBufferLike | {}, tileKey: TileKey, styleSetEvaluator: StyleSetEvaluator, projection: Projection): Promise<DecodedTile>;
}
//# sourceMappingURL=ThemedTileDecoder.d.ts.map