...
const PlacementStats_1 = require("./PlacementStats");
const SimplePath_1 = require("./SimplePath");
const TextElement_1 = require("./TextElement");
const TextElementsRendererOptions_1 = require("./TextElementsRendererOptions");
const TextElementStateCache_1 = require("./TextElementStateCache");
const TextElementType_1 = require("./TextElementType");
const UpdateStats_1 = require("./UpdateStats");
var Pass;
(function (Pass) {
...
class TextElementsRenderer {
     ...
     */
    constructor(m_viewState, m_viewCamera, m_viewUpdateCallback, m_screenCollisions, m_screenProjector, m_textCanvasFactory, m_poiManager, m_poiRendererFactory, m_fontCatalogLoader, m_textStyleCache, options) {
        ...
        this.m_textStyleCache = m_textStyleCache;
    ...
    addPointLabel(labelState, position, screenPosition, poiRenderer, textCanvas, renderParams, iconIndex) {
        ...
        if (renderText) {
            ...
            const placeResult = iconRejected && newLabel
                ...
                : Placement_1.placePointLabel(labelState, tempScreenPosition, distanceScaleFactor, textCanvas, this.m_viewState.env, this.m_screenCollisions, tempPosition, iconIndex === undefined);
            ...
            const iconIsRequired = !((poiInfo === null || poiInfo === void 0 ? void 0 : poiInfo.iconIsOptional) === false);
            ...
            const requiredIconRejected = iconRejected && iconReady && iconIsRequired;
    ...
    addPoiLabel(labelState, poiRenderer, textCanvas, renderParams) {
        ...
        const projectionResult = this.m_screenProjector.projectToScreen(worldPosition, tempScreenPosition);
    ...
    addLineMarkerLabel(labelState, poiRenderer, shieldGroups, textCanvas, renderParams) {
        ...
        if (minDistanceSqr > 0 && shieldGroup !== undefined) {
            for (let pointIndex = 0; pointIndex < path.length; ++pointIndex) {
                ...
                const projectionResult = this.m_screenProjector.projectToScreen(point, tempScreenPosition);
                if (projectionResult !== undefined) {
